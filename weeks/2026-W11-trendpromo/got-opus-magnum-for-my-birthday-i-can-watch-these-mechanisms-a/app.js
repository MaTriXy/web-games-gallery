const GAME_TITLE = `Magnum Opus Relay`;
const ACCENT = `#C46A2D`;
const MODE = `dodge_stream`;
const THEME_LABEL = `Got Opus Magnum for my birthday. I can watch these mechanisms ALL DAY.`;
const MOTIF_A = `opus`;
const MOTIF_B = `magnum`;
const OBJECTIVE_TAG = `opus vs magnum`;
