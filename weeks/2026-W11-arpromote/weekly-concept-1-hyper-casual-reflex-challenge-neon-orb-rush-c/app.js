const GAME_TITLE = `Weekly Concept Neon Board`;
const ACCENT = `#19F0C1`;
const MODE = `tap_targets`;
const THEME_LABEL = `Weekly concept 1: hyper-casual reflex challenge`;
const MOTIF_A = `weekly`;
const MOTIF_B = `concept`;
const OBJECTIVE_TAG = `weekly vs concept`;
const STAR_THRESHOLDS = [1200,2800,5000];
